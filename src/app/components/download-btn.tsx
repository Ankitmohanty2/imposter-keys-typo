...
export function DownloadButton({ text, isDark, showControls, onCopyLink }: DownloadButtonProps) {
  ...
  const handleDownload = async () => {
    ...
    a.href = dataUrl;
            a.download = `imposter-keys-typo-${new Date().toISOString().split("T")[0]}.png`;
    a.click();
  ...
  const handleDownloadJpeg = async () => {
    ...
    const a = document.createElement("a");
    a.href = dataUrl;
            a.download = `imposter-keys-typo-${new Date().toISOString().split("T")[0]}.jpg`;
    a.click();
    setIsDropdownOpen(false);
  }
  ...
  const handleDownloadSvg = async () => {
    ...
    const a = document.createElement("a");
    a.href = dataUrl;
            a.download = `imposter-keys-typo-${new Date().toISOString().split("T")[0]}.svg`;
    a.click();
    setIsDropdownOpen(false);
  }
